          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li class="active"><a href="jamora-blog.php">JOSHUA</a></li>
     ...
     <section>
          <div class="container">
               <div class="text-center">
                    <h1>Getting the best out of the worst.</h1>
                    <h3>Jamora, Joshua O.</h3>
               ...
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="footer-info">
                              ...
                              <ul class="social-icon">
                                   <li><a href="https://www.facebook.com/juswawubslinlen/" class="fa fa-facebook-square" attr="facebook icon"></a></li>
                                   <li><a href="https://www.twitter.com/" class="fa fa-twitter"></a></li>
                                   <li><a href="https://www.instagram.com/juicewah10/" class="fa fa-instagram"></a></li>
                              </ul>
                    ...
                    <div class="col-md-4 col-sm-6">
                         <div class="footer-info">
                              ...
                              <address>
                                   <p>09208001631</p>
                                   <p><a href="mailto:contact@company.com">jamora_joshua@plpasig.edu.ph</a></p>
                              </address>
